        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li><a href="{{ url('admin/author') }}"><i class="fa fa-book"></i> <span>Authors </span></a></li>
                    <li><a href="{{ url('admin/prodi') }}"><i class="fa fa-book"></i> <span>Program Study </span></a>
                    </li>
                    <li><a href="{{ url('admin/type') }}"><i class="fa fa-book"></i> <span>Types </span></a></li>
                    <li><a href="{{ url('admin/repository') }}"><i class="fa fa-book"></i> <span>Repository
                            </span></a></li>
                    <li><a href="{{ url('admin/editpassword/edit') }}"><i class="fa fa-gear"></i> <span>Ubah Password
                            </span></a></li>
