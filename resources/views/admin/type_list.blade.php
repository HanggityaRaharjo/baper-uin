        ...
        <div class='col-xs-12'>
            <div class='box'>
                <div class='box-header'>
                    <h3 class='box-title'>TYPE LIST <br><br><a href="{{ url('admin/tambahtype') }}"
                            ...
                            @foreach ($type as $a)
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center" width="140px">
                                        <a href="{{ url('admin/edittype/edit') }}/{{ $a->id }}" title="edit"
                                            class="btn btn-danger btn-sm"><i class="fa fa-pencil-square-o"></i></a>
                                        <a href="{{ url('admin/deletetype/delete') }}/{{ $a->id }}" title="delete"
